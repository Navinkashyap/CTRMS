...
export default function Membership() {
  ...
  const handleEditClick = (membership) => {
    ...
    setFormData({ name: membership.name, status: membership.status });
    setIsModalOpen(true);
  };
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] p-6 lg:p-10 font-sans text-slate-900">
      <div className="max-w-[900px] mx-auto space-y-8 animate-in fade-in duration-700 slide-in-from-bottom-2">
            ...
            <div className="relative px-8 py-8">
              <div className="flex justify-between items-start mb-6">
                <div className="space-y-1">
                  ...
                  <p className="text-slate-500 text-sm font-medium">Manage affiliations.</p>
                </div>
              ...
              <form onSubmit={handleSave} className="space-y-6">
                <div className="grid grid-cols-1 gap-6">
                  <div className="space-y-2 group">
                    <label className="text-xs font-black text-slate-400 uppercase tracking-widest pl-1">Membership Name</label>
                    <input 
