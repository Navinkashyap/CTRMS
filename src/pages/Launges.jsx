      ...
      <div className="max-w-[1200px] mx-auto space-y-8">
        ...
        <div className="bg-white/70 backdrop-blur-xl border border-slate-200 rounded-[2rem] shadow-2xl shadow-slate-200/50 p-2 overflow-hidden">
                  ...
                  <tr key={lang.id} className="group hover:bg-blue-50/40 transition-all duration-300 ease-out cursor-default">
                    ...
                    <td className="px-6 py-5">
                      <div className={`inline-flex items-center gap-2 px-3 py-1 rounded-full text-[11px] font-bold tracking-wide border ${lang.status === 'Active'
                        ...
                        <span className={`w-1.5 h-1.5 rounded-full ${lang.status === 'Active' ? 'bg-emerald-500' : 'bg-rose-500'} animate-pulse`} />
                        {lang.status}
                      </div>
                    </td>
                    <td className="px-6 py-5 text-center">
          ...
          <div className="px-8 py-5 flex items-center justify-between border-t border-slate-50 text-xs font-bold text-slate-600 tracking-wider uppercase">
            <span>Showing {filteredLanguages.length} of {languages.length} entries</span>
            ...
            <div className="relative px-8 py-8">
              <div className="flex justify-between items-start mb-6">
                <div className="space-y-1">
                  ...
                  <p className="text-slate-500 text-sm font-medium">Register global communication units.</p>
                </div>
              ...
              <form onSubmit={handleSave} className="space-y-6">
                <div className="grid grid-cols-1 gap-6">
                  <div className="space-y-2 group">
                    <label className="text-xs font-black text-slate-600 uppercase tracking-widest pl-1">Language Name</label>
                    <input
