...
import { getServices, createService, updateService, deleteService } from '../lib/serviceApi';
...
export default function Services() {
  ...
  const handleSave = async (e) => {
    ...
    try {
      ...
      showNotification("Failed to save service.");
    }
  };
            ...
            <table className="w-full text-left text-[14px] border-collapse min-w-[900px]">
              ...
              <tbody className="divide-y divide-slate-50">
                {filteredServices.map((service, index) => (
                  <tr key={service._id} className="group hover:bg-blue-50/40 transition-all duration-300 ease-out cursor-default">
                    ...
                    <td className="px-6 py-5">
                      <div className={`inline-flex items-center gap-2 px-3 py-1 rounded-full text-[11px] font-bold tracking-wide border ${service.status === 'Active'
                ...
                <div className="grid grid-cols-1 gap-6">
                  <div className="grid grid-cols-2 gap-6">
                    <div className="space-y-2 group">
                      <label className="text-xs font-black text-slate-600 uppercase tracking-widest pl-1">Service Title</label>
                      <input
                  ...
                  <div className="grid grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <label className="text-xs font-black text-slate-600 uppercase tracking-widest pl-1">Priority</label>
                      <input
                  ...
                  <div className="space-y-2">
                    <label className="text-xs font-black text-slate-600 uppercase tracking-widest pl-1">Parent Service</label>
